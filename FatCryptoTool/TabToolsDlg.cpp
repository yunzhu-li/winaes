...
HBRUSH CTabToolsDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
	...
	if (pWnd != &this->_ctl_edit_gpass && pWnd != &this->_ctl_edit_b64_input)
	{
...
void CTabToolsDlg::OnBnClickedBtnB64Enc()
{
	...
	//Allocate Memory
	TCHAR *_msg_in_unicode = new TCHAR[_msgLen + 2];
	...
	TCHAR *_msg_out_unicode = new TCHAR[_msgLen_Out + 2];
